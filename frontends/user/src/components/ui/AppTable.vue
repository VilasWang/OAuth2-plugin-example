...
<template>
  <div class="overflow-hidden rounded-card border border-neutral-200 bg-surface">
      ...
      <table class="min-w-full divide-y divide-neutral-200">
        <thead>
          <tr>
            <th
              ...
              :class="[
                'px-3 py-[9px] text-[10.5px] font-semibold text-neutral-500 uppercase tracking-[0.09em] select-none',
                colAlign(col),
              ]"
            >
              <button
                v-if="col.sortable"
                class="inline-flex items-center gap-1 rounded-[2px] hover:text-neutral-700 transition-colors
        ...
        <tbody class="divide-y divide-neutral-100">
          ...
          <tr
            ...
            class="hover:bg-page transition-colors"
          >
            <td
              v-for="col in columns"
              :key="col.key"
