...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-50 to-brand-100 px-4">
    <div class="w-full max-w-md bg-surface rounded-2xl shadow-xl p-8 text-center">
      ...
      <div v-else-if="status === 'success'">
        ...
        <router-link
          to="/login"
          class="mt-6 inline-block px-6 py-2 bg-brand-600 text-white rounded-lg hover:bg-brand-700"
        >
          Go to Login
        </router-link>
      </div>
