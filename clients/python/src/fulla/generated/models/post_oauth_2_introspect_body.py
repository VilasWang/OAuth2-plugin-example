...
T = TypeVar("T", bound="PostOauth2IntrospectBody")


@_attrs_define
class PostOauth2IntrospectBody:
    """
    Attributes:
        token (str): The string value of the token (required).
        ...
        client_secret (str | Unset): Client secret (alternative to HTTP Basic authentication).
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_oauth_2_introspect_body = cls(
            token=token,
        ...
        post_oauth_2_introspect_body.additional_properties = d
        return post_oauth_2_introspect_body
