...
class TokenRequest:
    ...
    scope; device_code needs device_code. Client auth follows the client's registered token_endpoint_auth_method
    (F-017): client_secret_basic (default) -> HTTP Basic ONLY; client_secret_post -> these form fields ONLY; 'none'
    (PUBLIC) -> client_id only, secrets rejected.
