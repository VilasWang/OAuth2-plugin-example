"""Machine-to-machine (client_credentials) authentication for Fulla.

This module is the blessed entry point for the most common SDK usage: a
confidential client talking to Fulla's token endpoint with the
...
class FullaAuthError(RuntimeError):
