...
T = TypeVar("T", bound="GetApiAdminOrganizationsResponse200")


@_attrs_define
class GetApiAdminOrganizationsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_admin_organizations_response_200 = cls(
            organizations=organizations,
            total=total,
        )

        get_api_admin_organizations_response_200.additional_properties = d
        return get_api_admin_organizations_response_200
