...
T = TypeVar("T", bound="PostApiAdminOrganizationsResponse200")


@_attrs_define
class PostApiAdminOrganizationsResponse200:
    """
    Attributes:
        id (int | Unset):
        slug (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_admin_organizations_response_200 = cls(
            id=id,
            slug=slug,
            name=name,
            logo_uri=logo_uri,
        ...
        post_api_admin_organizations_response_200.additional_properties = d
        return post_api_admin_organizations_response_200
