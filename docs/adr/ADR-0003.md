...
date: 2026-08-26
status: accepted
source: docs/history/design/kiro-specs/error-code-message-standardization/design.md（AD-1..AD-6）+ auth-flow-error-code-gaps（不折叠原则）
---

# ADR-0003：ErrorCatalog 单一权威来源与双通道错误处理
