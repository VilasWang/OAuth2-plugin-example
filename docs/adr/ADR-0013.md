...
- One language switcher per app drives both page chrome and error messages: `getErrorMessage(code)` defaults to the active UI locale; `DEFAULT_LOCALE` becomes the fallback table (`en`).
