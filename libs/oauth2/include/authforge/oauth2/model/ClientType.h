...
// Task 17 slice 2 (authforge-sdk-refactor, design.md §6/§8): libs/oauth2
// Domain model. Ports oauth2::ClientType (currently
// OAuth2Plugin/include/oauth2/types/OAuth2Types.h) verbatim into
// authforge::oauth2::model, since OAuth2Client (this slice's main DTO)
...
// codes into authforge::common's framework-agnostic ErrorCatalog, so
