...
// Task 17 (fulla-sdk-refactor, design.md §8/§17): libs/oauth2 Domain
...
// (which hardcodes a static fulla::drogon::adapters::OpenSslCryptoProvider
// instance -- fine for an Adapter-layer convenience header, but not
// allowed here), every function below takes an
// fulla::common::ports::ICryptoProvider& as an explicit parameter:
...
bool verifyCodeVerifier(
  const std::string &codeVerifier,
  const fulla::common::model::PkceChallenge &challenge,
  fulla::common::ports::ICryptoProvider &crypto
);
