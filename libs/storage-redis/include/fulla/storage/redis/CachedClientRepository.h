...
// fulla-sdk-refactor Task 11). Supersedes the "wrap the whole god
...
// validateClient()).
//
// Phase 4.4 (fulla-sdk-refactor): now implements the NEW Domain-layer
// interface fulla::oauth2::repository::IClientRepository (+ the
// fulla::oauth2::model::* DTOs) instead of the legacy oauth2 one. Types are
...
// fulla::oauth2::repository::IClientRepository.
using CachedClientRepositoryBase = ::fulla::oauth2::repository::IClientRepository;
                               ...
                               public std::enable_shared_from_this<CachedClientRepository>
{
  ...
  private:
    ...
    ::drogon::CacheMap<std::string, ::fulla::oauth2::model::OAuth2Client> clientCache_;
};
