...
// M2b Task 17 slice 5 (authforge-sdk-refactor, design.md §3.3/§5.1/§6):
// libs/common ports. IAuditSink is the port Domain code (e.g. libs/oauth2's
// TokenService, once migrated) uses to emit an
// authforge::common::observability::AuditEvent without depending on the
...
class IAuditSink
{
  public:
    ...
    virtual void record(const authforge::common::observability::AuditEvent &event) = 0;
};
