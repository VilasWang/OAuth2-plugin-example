...
// Task 13 (fulla-sdk-refactor, design.md §4.1/§5.1/§6): libs/common
...
// fulla::common::error happens in a later M2a task (Task 14/16) once
...
//
// namespace: fulla::common::error (design.md §6 "命名空间同步：
// fulla::common::error/fulla::common::config -> fulla::common::").
 ...
 * the pre-existing fulla::common::error::ErrorCategory contract).
 */
