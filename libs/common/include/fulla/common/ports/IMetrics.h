...
// Task 13 (fulla-sdk-refactor, design.md §3.3/§5.1/§5.4/§6): libs/common
// ports. IMetrics is the generic metrics-emission port design.md §5.4
// assigns to Adapter implementations ("Prometheus 导出 | fulla::
...
// referenced there): the existing fulla::drogon::observability::Metrics
// (libs/drogon/include/fulla/drogon/observability/Metrics.h) is a static
