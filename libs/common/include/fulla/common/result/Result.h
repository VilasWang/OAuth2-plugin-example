...
// Task 13 (fulla-sdk-refactor, design.md §3.1/§5.1/§6): libs/common
...
//  - E defaults to fulla::common::error::Error (the Domain-wide error
 ...
 * @tparam E Error value type (defaults to fulla::common::error::Error).
 */
template <typename T, typename E = fulla::common::error::Error>
class Result
{
  public:
