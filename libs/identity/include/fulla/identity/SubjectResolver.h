...
// production implementation of fulla::common::ports::ISubjectResolver,
 ...
 * localId). Mirrors fulla::common::utils::SubjectGenerator::parse's fallback
...
class SubjectResolver : public fulla::common::ports::ISubjectResolver
{
  public:
