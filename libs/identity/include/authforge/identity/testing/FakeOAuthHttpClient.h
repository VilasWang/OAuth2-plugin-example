// libs/identity/include/authforge/identity/testing/FakeOAuthHttpClient.h
//
// Shared test double for authforge::identity::IOAuthHttpClient. Promoted
...
// library -- every test target that links authforge::identity gets these
