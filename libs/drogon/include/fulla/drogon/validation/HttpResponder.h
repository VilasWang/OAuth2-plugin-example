...
// it delegates to the unified fulla::common::error machinery so every validation
...
// `details` are gated by fulla::common::error::ErrorContext (Requirement 7.6).
//
...
class HttpResponder
{
  ...
  private:
    ...
    // error strings, delegating to fulla::common::error::Error / ErrorContext.
