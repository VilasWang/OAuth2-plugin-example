...
// Task 14 (fulla-sdk-refactor, design.md §5.6): this header no longer
// calls drogon::utils::* directly. Every function below now delegates to
// fulla::drogon::adapters::OpenSslCryptoProvider (the Adapter-side default
// implementation of fulla::common::ports::ICryptoProvider added in
...
inline fulla::drogon::adapters::OpenSslCryptoProvider &cryptoProvider()
{
    static fulla::drogon::adapters::OpenSslCryptoProvider instance;
    return instance;
}
}  // namespace detail
...
inline std::string generateSecureToken(size_t bytes = 32)
{
    ...
    if (!detail::cryptoProvider().secureRandomBytes(buffer.data(), bytes))
    {
        ...
        fulla::drogon::adapters::OpenSslUuidGenerator uuidGenerator;
