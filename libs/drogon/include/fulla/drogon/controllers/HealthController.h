...
// M3 Task 20 slice 3 (fulla-sdk-refactor): relocated from
// OAuth2Server/controllers/HealthController.h into
// fulla::drogon::controllers, as the CORE EXPERIMENT verifying
...
// full <fulla/drogon/plugin/OAuth2Plugin.h> just to hold a pointer member.
class OAuth2Plugin;
