...
)
{
    ...
    try
    {
        ...
        mapper.insert(
          client,
          [sharedCb, clientId, clientSecret, clientName, redirectUrisArray,
           grantTypesArray, issuedAt, tokenEndpointAuthMethod, req](
            const Oauth2Clients &
          ) {
              Json::Value json;
              ...
              ::authforge::drogon::adapters::DrogonAuditSink::logFromRequest(
                ...
                "client_registered", "success", req, "", "client", clientId
              );
          ...
          [sharedCb, req](const DrogonDbException &e) {
              ::authforge::drogon::adapters::DrogonAuditSink::logFromRequest(
                ::drogon::app().getPlugin<::OAuth2Plugin>()->getAuditSink(),
                "client_registered", "failure", req, "", "client", "",
    ...
    {
        respondError(
          req, sharedCb, "DB_CONNECTION_ERROR",
          "registerClient: database connection error"
        );
    }
}
